...
{
	[Library]
	public partial class SpiderController : BasePlayerController
	{
		...
		[Net] public float AirAcceleration { get; set; } = 8.0f;
		...
		[Net] public float Gravity { get; set; } = 900.0f;
		[Net] public float AirControl { get; set; } = 260.0f;
